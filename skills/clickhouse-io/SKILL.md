---
name: clickhouse-io
description: ClickHouse database patterns, query optimization, analytics, and data engineering best practices for high-performance analytical workloads. Use when querying ClickHouse, designing analytics schemas, optimizing ClickHouse performance, or working with large-scale event or time-series data.
origin: ECC
license: MIT
version: 1.0.0
metadata:
