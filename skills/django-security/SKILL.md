...
description: Django security best practices, authentication, authorization, CSRF protection, SQL injection prevention, XSS prevention, and secure deployment configurations. Use when securing Django apps, implementing Django authentication, CSRF protection, or reviewing Django security posture.
origin: ECC
license: MIT
version: 1.0.0
metadata:
