---
name: django-tdd
description: Django testing strategies with pytest-django, TDD methodology, factory_boy, mocking, coverage, and testing Django REST Framework APIs. Use when writing Django tests with pytest-django, applying TDD to Django views/models, or setting up Django test factories.
origin: ECC
license: MIT
version: 1.0.0
metadata:
