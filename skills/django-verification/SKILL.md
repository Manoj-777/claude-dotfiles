...
description: "Verification loop for Django projects: migrations, linting, tests with coverage, security scans, and deployment readiness checks before release or PR. Use when verifying Django project health, running Django migrations and tests, or doing a pre-deploy Django sanity check."
origin: ECC
license: MIT
version: 1.0.0
metadata:
