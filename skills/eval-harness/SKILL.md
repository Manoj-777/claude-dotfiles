---
name: eval-harness
description: Formal evaluation framework for Claude Code sessions implementing eval-driven development (EDD) principles Use when building formal evaluations for Claude Code sessions, implementing LLM eval frameworks, or measuring Claude session output quality systematically.
origin: ECC
