...
description: Suggests manual context compaction at logical intervals to preserve context through task phases rather than arbitrary auto-compaction. Use when approaching context window limits in long sessions, deciding when to manually compact context, or preserving critical information before context loss.
origin: ECC
license: MIT
version: 1.0.0
metadata:
